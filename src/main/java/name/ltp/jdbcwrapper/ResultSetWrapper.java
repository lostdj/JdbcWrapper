...
{
	public StatementWrapper s;
	public ResultSet r;
	public final long time;
	public final StackTraceElement[] stack;

	public ResultSetWrapper(StatementWrapper s, ResultSet r)
	{
		this.s = s;
		this.r = r;
	...
	@Override @SuppressWarnings("deprecation") public BigDecimal getBigDecimal(int columnIndex, int scale) throws SQLException
	{
	...
	@Override @SuppressWarnings("deprecation") public
